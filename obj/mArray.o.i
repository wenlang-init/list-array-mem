...
struct _arrayobj{
    ...
    {
        Array_Node *(*insert_head)(Array *obj,void *data);
        Array_Node *(*append)(Array *obj,void *data);
        Array_Node *(*insert)(Array *obj,int index,void *data);

        int (*remove)(Array *obj,int index);
        int (*remove_d)(Array *obj,int index);
        int (*remove_node)(Array *obj,Array_Node *node);
        int (*remove_node_d)(Array *obj,Array_Node *node);

        void (*clear)(Array *obj);
        void (*clear_d)(Array *obj);

        void (*destroy)(Array *obj);
        void (*destroy_d)(Array *obj);

        int (*get_node_index)(Array *obj,Array_Node *node);
        Array_Node *(*at)(Array *obj,int index);

        int (*find_node_index)(Array *obj,void *data);

        int (*swap)(Array *obj,int i,int j);
        int (*move)(Array *obj,int i,int j);
    }func;
...
# 27 "./array/mArray.c" 3 4
       ((void *)0)
# 27 "./array/mArray.c"
       ,write_log_format_data, "./array/mArray.c", 27,__FUNCTION__); } }while (0);
        return 
# 28 "./array/mArray.c" 3 4
              ((void *)0)
# 28 "./array/mArray.c"
                  ;
    }

    array->ro.node_max = 1024*2;
    array->ro.index = (Array_Node *)malloc(sizeof(Array_Node)*array->ro.node_max);
    if(array->ro.index == 
# 33 "./array/mArray.c" 3 4
                         ((void *)0)
# 33 "./array/mArray.c"
                             ){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "malloc:%s\n",strerror(
# 34 "./array/mArray.c" 3 4
       (*__errno_location ())
# 34 "./array/mArray.c"
       )); write_log(
# 34 "./array/mArray.c" 3 4
       ((void *)0)
# 34 "./array/mArray.c"
       ,write_log_format_data, "./array/mArray.c", 34,__FUNCTION__); } }while (0);
        free(array);
        return 
# 36 "./array/mArray.c" 3 4
              ((void *)0)
# 36 "./array/mArray.c"
                  ;
    }
...
{
    if(obj == 
# 77 "./array/mArray.c" 3 4
             ((void *)0)
# 77 "./array/mArray.c"
                 ){
        return -1;
    }
    if(obj->ro.count >= obj->ro.node_max-10){

        Array_Node *p = (Array_Node *)realloc(obj->ro.index,(obj->ro.node_max+1024)*sizeof(Array_Node));
        if(p == 
# 83 "./array/mArray.c" 3 4
               ((void *)0)
# 83 "./array/mArray.c"
                   ){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "realloc:%s\n",strerror(
# 84 "./array/mArray.c" 3 4
           (*__errno_location ())
# 84 "./array/mArray.c"
           )); write_log(
# 84 "./array/mArray.c" 3 4
           ((void *)0)
# 84 "./array/mArray.c"
           ,write_log_format_data, "./array/mArray.c", 84,__FUNCTION__); } }while (0);
            return -1;
        }
        obj->ro.index = p;
        obj->ro.node_max += 1024;
    } else if(obj->ro.node_max >= obj->ro.count+10 +1024*2 +1024){
        Array_Node *p = (Array_Node *)realloc(obj->ro.index,(obj->ro.node_max-1024)*sizeof(Array_Node));
        if(p == 
# 91 "./array/mArray.c" 3 4
               ((void *)0)
# 91 "./array/mArray.c"
                   ){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "realloc:%s\n",strerror(
# 92 "./array/mArray.c" 3 4
           (*__errno_location ())
# 92 "./array/mArray.c"
           )); write_log(
# 92 "./array/mArray.c" 3 4
           ((void *)0)
# 92 "./array/mArray.c"
           ,write_log_format_data, "./array/mArray.c", 92,__FUNCTION__); } }while (0);
            return 0;
        }
        obj->ro.index = p;
        obj->ro.node_max -= 1024;
...
{
    if(obj == 
# 111 "./array/mArray.c" 3 4
             ((void *)0)
# 111 "./array/mArray.c"
                 ){
        return 
# 112 "./array/mArray.c" 3 4
              ((void *)0)
# 112 "./array/mArray.c"
                  ;
    }
...
{
    if(obj == 
# 142 "./array/mArray.c" 3 4
             ((void *)0)
# 142 "./array/mArray.c"
                 ){
        return 
# 143 "./array/mArray.c" 3 4
              ((void *)0)
# 143 "./array/mArray.c"
                  ;
    }
...
{
    if(obj == 
# 168 "./array/mArray.c" 3 4
             ((void *)0)
# 168 "./array/mArray.c"
                 ){
        return 
# 169 "./array/mArray.c" 3 4
              ((void *)0)
# 169 "./array/mArray.c"
                  ;
    }
...
# 234 "./array/mArray.c"
    ...
    if(obj->ro.index[index].data != 
# 242 "./array/mArray.c" 3 4
                                   ((void *)0)
# 242 "./array/mArray.c"
                                       ){
...
# 324 "./array/mArray.c"
    ...
    for(i=0;i<obj->ro.count;i++){
        if(obj->ro.index[i].data != 
# 330 "./array/mArray.c" 3 4
                                   ((void *)0)
# 330 "./array/mArray.c"
                                       ){
...
{
    if(obj == 
# 408 "./array/mArray.c" 3 4
             ((void *)0)
# 408 "./array/mArray.c"
                 ){
        return 
# 409 "./array/mArray.c" 3 4
              ((void *)0)
# 409 "./array/mArray.c"
                  ;
    }
