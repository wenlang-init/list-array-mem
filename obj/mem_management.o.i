...
static char mem_buf[1024*1024];

static unsigned short mem_management_table[1024*1024/32];

struct _mem_man_dev{
    void (*init)(void);
    unsigned char (*peruser)(void);
    u8 *membase;
    u16 *memmap;
    u32 mem_size;
    u32 memtable_size;
...
void mem_free(void *ptr){
    u32 offset;
    if(ptr == 0 || ((u8*)ptr < mem_dev.membase))return;
