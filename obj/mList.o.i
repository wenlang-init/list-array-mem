# 1 "./list/mList.c"
# 1 "/mnt/d/work/vmware/work/tt/list-array-mem//"
# 1 "<built-in>"
#define __STDC__ 1
...
struct _listobj{
    ...
    struct _function
    {
        List_Node *(*append)(List *obj,void *data);
        List_Node *(*insert_next)(List *obj,List_Node *node,void *data);
        List_Node *(*insert_prev)(List *obj,List_Node *node,void *data);


        List_Node *(*insert_at)(List *obj,int index,void *data);

        int (*swap)(List *obj,int i,int j);
        int (*move)(List *obj,int i,int j);


        List_Node *(*find_node)(List *obj,void *data);
        ...
        int (*remove_node_d)(List *obj,List_Node *node);

        int (*remove_node_at)(List *obj,int index);
        int (*remove_node_at_d)(List *obj,int index);

        void (*remove_node_all)(List *obj);
        void (*remove_node_all_d)(List *obj);

        void (*delete)(List *obj);
        void (*delete_d)(List *obj);
...
# 231 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 3 4
#undef __need_size_t
# 401 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 3 4
#undef __need_NULL
...
# 328 "/usr/include/x86_64-linux-gnu/bits/stdio2.h" 3 4
...
#define WRITE_LOG(obj,__format,...) do { if(WRITE_LOG_VAILD_STATE){ char write_log_format_data[ADTA_MAXSIZE]; snprintf(write_log_format_data, ADTA_MAXSIZE, __format, ##__VA_ARGS__); write_log(obj,write_log_format_data, __FILE__, __LINE__,__FUNCTION__); } }while (0)
# 53 "./list/../log/log_info.h"
...
# 27 "./list/mList.c"
        ...
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "malloc:%s\n",strerror(
# 28 "./list/mList.c" 3 4
       (*__errno_location ())
# 28 "./list/mList.c"
       )); write_log(
# 28 "./list/mList.c" 3 4
       ((void *)0)
# 28 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 28,__FUNCTION__); } }while (0);
        return 
# 29 "./list/mList.c" 3 4
              ((void *)0)
# 29 "./list/mList.c"
...
# 35 "./list/mList.c" 3 4
       ((void *)0)
# 35 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 35,__FUNCTION__); } }while (0);
        free(listobj);
        return 
# 37 "./list/mList.c" 3 4
              ((void *)0)
...
# 43 "./list/mList.c" 3 4
       ((void *)0)
# 43 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 43,__FUNCTION__); } }while (0);
...
# 55 "./list/mList.c" 3 4
       ((void *)0)
# 55 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 55,__FUNCTION__); } }while (0);
        free(headinfo);
        free(listobj->ro.head);
        free(listobj);
        return 
...
{
    if(headinfo == 
# 106 "./list/mList.c" 3 4
                  ((void *)0)
# 106 "./list/mList.c"
                      ){
        return 0;
    }
    if(headinfo->count >= headinfo->node_max - 10){

        List_Node **p = (List_Node **)realloc(headinfo->index,(headinfo->node_max+1024)*sizeof(List_Node *));
        if(p == 
# 112 "./list/mList.c" 3 4
               ((void *)0)
# 112 "./list/mList.c"
                   ){
            return -1;
        ...
        memset(headinfo->index + headinfo->node_max,0,1024*sizeof(List_Node *));

        headinfo->node_max += 1024;

        obj->index = headinfo->index;

    } else if(headinfo->node_max >= headinfo->count + 10 + 1024*2 + 1024){

        List_Node **p = (List_Node **)realloc(headinfo->index,(headinfo->node_max-1024)*sizeof(List_Node *));
        if(p == 
# 126 "./list/mList.c" 3 4
               ((void *)0)
# 126 "./list/mList.c"
                   ){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "reduce menory failed\n"); write_log(
# 127 "./list/mList.c" 3 4
           ((void *)0)
# 127 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 127,__FUNCTION__); } }while (0);
            return 0;
        }
        headinfo->index = p;
...
{
    if(obj == 
# 189 "./list/mList.c" 3 4
             ((void *)0)
# 189 "./list/mList.c"
                 ){
        return 
# 190 "./list/mList.c" 3 4
              ((void *)0)
# 190 "./list/mList.c"
                  ;
    }
    List_Node *head = obj->ro.head;
    if(head == 
# 193 "./list/mList.c" 3 4
              ((void *)0)
# 193 "./list/mList.c"
                  ){
        return 
# 194 "./list/mList.c" 3 4
              ((void *)0)
# 194 "./list/mList.c"
                  ;
    } else {
        ...
        if(n == 
# 197 "./list/mList.c" 3 4
               ((void *)0)
# 197 "./list/mList.c"
                   ){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "malloc:%s\n",strerror(
# 198 "./list/mList.c" 3 4
           (*__errno_location ())
# 198 "./list/mList.c"
           )); write_log(
# 198 "./list/mList.c" 3 4
           ((void *)0)
# 198 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 198,__FUNCTION__); } }while (0);
            return 
# 199 "./list/mList.c" 3 4
                  ((void *)0)
# 199 "./list/mList.c"
                      ;
        }
        ...
        if(0 != memory_extension(obj,headinfo)){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "insert_node_head failed\n"); write_log(
# 204 "./list/mList.c" 3 4
           ((void *)0)
# 204 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 204,__FUNCTION__); } }while (0);
            return 
# 205 "./list/mList.c" 3 4
                  ((void *)0)
# 205 "./list/mList.c"
                      ;
        }
...
{
    if(obj == 
# 240 "./list/mList.c" 3 4
             ((void *)0)
# 240 "./list/mList.c"
                 ){
        return 
# 241 "./list/mList.c" 3 4
              ((void *)0)
# 241 "./list/mList.c"
                  ;
    }
    List_Node *head = obj->ro.head;
    if(head == 
# 244 "./list/mList.c" 3 4
              ((void *)0)
# 244 "./list/mList.c"
                  ){
        return 
# 245 "./list/mList.c" 3 4
              ((void *)0)
# 245 "./list/mList.c"
                  ;
    } else {
        ...
        List_Node *n = (List_Node *)malloc(sizeof(List_Node));
        if(n == 
# 262 "./list/mList.c" 3 4
               ((void *)0)
# 262 "./list/mList.c"
                   ){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "malloc:%s\n",strerror(
# 263 "./list/mList.c" 3 4
           (*__errno_location ())
# 263 "./list/mList.c"
           )); write_log(
# 263 "./list/mList.c" 3 4
           ((void *)0)
# 263 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 263,__FUNCTION__); } }while (0);
            return 
# 264 "./list/mList.c" 3 4
                  ((void *)0)
# 264 "./list/mList.c"
                      ;
        }
        ...
        if(0 != memory_extension(obj,headinfo)){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "insert_node_head failed\n"); write_log(
# 269 "./list/mList.c" 3 4
           ((void *)0)
# 269 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 269,__FUNCTION__); } }while (0);
            return 
# 270 "./list/mList.c" 3 4
                  ((void *)0)
# 270 "./list/mList.c"
                      ;
        }
...
List_Node *insert_node_next(List *obj,List_Node *node,void *data){
    if(node == 
# 298 "./list/mList.c" 3 4
              ((void *)0)
# 298 "./list/mList.c"
                  ){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "insert failed\n"); write_log(
# 299 "./list/mList.c" 3 4
       ((void *)0)
# 299 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 299,__FUNCTION__); } }while (0);
        return 
# 300 "./list/mList.c" 3 4
              ((void *)0)
# 300 "./list/mList.c"
                  ;
    }
    if(obj == 
# 302 "./list/mList.c" 3 4
             ((void *)0)
# 302 "./list/mList.c"
                 ){
        return 
# 303 "./list/mList.c" 3 4
              ((void *)0)
# 303 "./list/mList.c"
                  ;
    }
    ...
    if(0 != check_node(obj,node)){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "have not found node in list\n"); write_log(
# 307 "./list/mList.c" 3 4
       ((void *)0)
# 307 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 307,__FUNCTION__); } }while (0);
        return 
# 308 "./list/mList.c" 3 4
              ((void *)0)
# 308 "./list/mList.c"
                  ;
    }
    ...
    List_Node *n = (List_Node *)malloc(sizeof(List_Node));
    if(n == 
# 312 "./list/mList.c" 3 4
           ((void *)0)
# 312 "./list/mList.c"
               ){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "malloc:%s\n",strerror(
# 313 "./list/mList.c" 3 4
       (*__errno_location ())
# 313 "./list/mList.c"
       )); write_log(
# 313 "./list/mList.c" 3 4
       ((void *)0)
# 313 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 313,__FUNCTION__); } }while (0);
        return 
# 314 "./list/mList.c" 3 4
              ((void *)0)
# 314 "./list/mList.c"
                  ;
    }
    struct _head_info *headinfo = (struct _head_info*)head->data;
        ...
        if(0 != memory_extension(obj,headinfo)){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "insert_node_head failed\n"); write_log(
# 319 "./list/mList.c" 3 4
           ((void *)0)
# 319 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 319,__FUNCTION__); } }while (0);
            return 
# 320 "./list/mList.c" 3 4
                  ((void *)0)
# 320 "./list/mList.c"
                      ;
        }
...
{
    if(obj == 
# 367 "./list/mList.c" 3 4
             ((void *)0)
# 367 "./list/mList.c"
                 ){
        return 
# 368 "./list/mList.c" 3 4
              ((void *)0)
# 368 "./list/mList.c"
                  ;
    }
    ...
    if(0 != check_node(obj,node)){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "have not found node in list\n"); write_log(
# 372 "./list/mList.c" 3 4
       ((void *)0)
# 372 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 372,__FUNCTION__); } }while (0);
        return 
# 373 "./list/mList.c" 3 4
              ((void *)0)
# 373 "./list/mList.c"
                  ;
    }
...
# 376 "./list/mList.c"
                                   || node == head){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "insert failed\n"); write_log(
# 377 "./list/mList.c" 3 4
       ((void *)0)
# 377 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 377,__FUNCTION__); } }while (0);
        return 
# 378 "./list/mList.c" 3 4
              ((void *)0)
# 378 "./list/mList.c"
                  ;
    }
    ...
    List_Node *n = (List_Node *)malloc(sizeof(List_Node));
    if(n == 
# 382 "./list/mList.c" 3 4
           ((void *)0)
# 382 "./list/mList.c"
               ){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "malloc:%s\n",strerror(
# 383 "./list/mList.c" 3 4
       (*__errno_location ())
# 383 "./list/mList.c"
       )); write_log(
# 383 "./list/mList.c" 3 4
       ((void *)0)
# 383 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 383,__FUNCTION__); } }while (0);
        return 
# 384 "./list/mList.c" 3 4
              ((void *)0)
# 384 "./list/mList.c"
                  ;
    }
    struct _head_info *headinfo = (struct _head_info*)head->data;
        ...
        if(0 != memory_extension(obj,headinfo)){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "insert_node_head failed\n"); write_log(
# 389 "./list/mList.c" 3 4
           ((void *)0)
# 389 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 389,__FUNCTION__); } }while (0);
            return 
# 390 "./list/mList.c" 3 4
                  ((void *)0)
# 390 "./list/mList.c"
                      ;
        }
...
{
    if(obj == 
# 431 "./list/mList.c" 3 4
             ((void *)0)
# 431 "./list/mList.c"
                 ){
        return 
# 432 "./list/mList.c" 3 4
              ((void *)0)
# 432 "./list/mList.c"
                  ;
    }
    ...
    if(0 != memory_extension(obj,headinfo)){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "insert_node_head failed\n"); write_log(
# 444 "./list/mList.c" 3 4
       ((void *)0)
# 444 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 444,__FUNCTION__); } }while (0);
        return 
# 445 "./list/mList.c" 3 4
              ((void *)0)
# 445 "./list/mList.c"
                  ;
    }
...
{
    if(obj == 
# 682 "./list/mList.c" 3 4
             ((void *)0)
# 682 "./list/mList.c"
                 ){
        return 
# 683 "./list/mList.c" 3 4
              ((void *)0)
# 683 "./list/mList.c"
                  ;
    }
...
{
    if(obj == 
# 711 "./list/mList.c" 3 4
             ((void *)0)
# 711 "./list/mList.c"
                 ){
        return 
# 712 "./list/mList.c" 3 4
              ((void *)0)
# 712 "./list/mList.c"
                  ;
    }
    if(0 != check_node(obj,node)){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "have not found node in list\n"); write_log(
# 715 "./list/mList.c" 3 4
       ((void *)0)
# 715 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 715,__FUNCTION__); } }while (0);
        return 
# 716 "./list/mList.c" 3 4
              ((void *)0)
# 716 "./list/mList.c"
                  ;
    }
...
{
    if(obj == 
# 733 "./list/mList.c" 3 4
             ((void *)0)
# 733 "./list/mList.c"
                 ){
        return 
# 734 "./list/mList.c" 3 4
              ((void *)0)
# 734 "./list/mList.c"
                  ;
    }
    if(0 != check_node(obj,node)){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "have not found node in list\n"); write_log(
# 737 "./list/mList.c" 3 4
       ((void *)0)
# 737 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 737,__FUNCTION__); } }while (0);
        return 
# 738 "./list/mList.c" 3 4
              ((void *)0)
# 738 "./list/mList.c"
                  ;
    }
...
{
    if(obj == 
# 809 "./list/mList.c" 3 4
             ((void *)0)
# 809 "./list/mList.c"
                 ){
        return 
# 810 "./list/mList.c" 3 4
              ((void *)0)
# 810 "./list/mList.c"
                  ;
    }
    List_Node *head = obj->ro.head;
    if(head == 
# 813 "./list/mList.c" 3 4
              ((void *)0)
# 813 "./list/mList.c"
                  ){
        return 
# 814 "./list/mList.c" 3 4
              ((void *)0)
# 814 "./list/mList.c"
                  ;
    }
...
# 878 "./list/mList.c"
    ...
    if(0 != check_node(obj,node)){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "have not found node in list\n"); write_log(
# 883 "./list/mList.c" 3 4
       ((void *)0)
# 883 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 883,__FUNCTION__); } }while (0);
        return -1;
    }
    if(head == 
# 886 "./list/mList.c" 3 4
              ((void *)0) 
# 886 "./list/mList.c"
                   || node == 
# 886 "./list/mList.c" 3 4
...
# 886 "./list/mList.c"
                                   || node == head){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "remove failed\n"); write_log(
# 887 "./list/mList.c" 3 4
       ((void *)0)
# 887 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 887,__FUNCTION__); } }while (0);
        return -1;
    }
    struct _head_info *headinfo = (struct _head_info*)head->data;

        if(0 != memory_extension(obj,headinfo)){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "remove_node failed\n"); write_log(
# 893 "./list/mList.c" 3 4
           ((void *)0)
# 893 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 893,__FUNCTION__); } }while (0);
            return -1;
        }
...
# 937 "./list/mList.c"
    ...
    if(0 != check_node(obj,node)){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "have not found node in list\n"); write_log(
# 942 "./list/mList.c" 3 4
       ((void *)0)
# 942 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 942,__FUNCTION__); } }while (0);
        return -1;
    }
    if(head == 
# 945 "./list/mList.c" 3 4
              ((void *)0) 
# 945 "./list/mList.c"
                   || node == 
# 945 "./list/mList.c" 3 4
...
# 945 "./list/mList.c"
                                   || node == head){
        do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "remove failed\n"); write_log(
# 946 "./list/mList.c" 3 4
       ((void *)0)
# 946 "./list/mList.c"
       ,write_log_format_data, "./list/mList.c", 946,__FUNCTION__); } }while (0);
        return -1;
    }
    struct _head_info *headinfo = (struct _head_info*)head->data;

        if(0 != memory_extension(obj,headinfo)){
            do { if(1){ char write_log_format_data[1024]; snprintf(write_log_format_data, 1024, "remove_node_all failed\n"); write_log(
# 952 "./list/mList.c" 3 4
           ((void *)0)
# 952 "./list/mList.c"
           ,write_log_format_data, "./list/mList.c", 952,__FUNCTION__); } }while (0);
            return -1;
        }
...
# 1006 "./list/mList.c"
    ...
    free(headinfo);
    head->data = 
# 1009 "./list/mList.c" 3 4
                ((void *)0)
# 1009 "./list/mList.c"
                    ;
    free(head);
    obj->ro.head = 
# 1011 "./list/mList.c" 3 4
                  ((void *)0)
# 1011 "./list/mList.c"
                      ;
    free(obj);
...
# 1036 "./list/mList.c"
    ...
    free(headinfo);
    head->data = 
# 1039 "./list/mList.c" 3 4
                ((void *)0)
# 1039 "./list/mList.c"
                    ;
    free(head);
    obj->ro.head = 
# 1041 "./list/mList.c" 3 4
                  ((void *)0)
# 1041 "./list/mList.c"
                      ;
    free(obj);
